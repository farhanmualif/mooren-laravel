        ...
        <div class="card-body">
            ...
            <div class="-mx-5 my-5 overflow-x-auto">
                <table class="w-full whitespace-nowrap">
                    ...
                    <tbody>
                        @php
                            $no = ($gunung->currentPage() - 1) * $gunung->perPage() + 1;
                        @endphp
                        @foreach ($gunung as $data)
                            <tr>
                                ...
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500 text-slate-500">
                                    {{ number_format($data->tinggi_gunung, 0, ',', '.') }} mdpl
                                </td>
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500 text-slate-500">
                                    {{ \Illuminate\Support\Str::limit(strip_tags($data->deskripsi), 50, '...') }}</td>
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                    <div class="flex gap-2">
                                        <a href="{{ route('edit-gunung', $data->id) }}"
                                        ...
                                        <a href="{{ route('hapus-gunung', $data->id) }}"
