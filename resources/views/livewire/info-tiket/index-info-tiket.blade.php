        ...
        <div class="card-body">
            ...
            <div class="-mx-5 my-5 overflow-x-auto">
                <table class="w-full whitespace-nowrap">
                    ...
                    <tbody>
                        @php
                            $no = ($info_tiket->currentPage() - 1) * $info_tiket->perPage() + 1;
                        @endphp
                        @foreach ($info_tiket as $data)
                            <tr>
                                <td
                                ...
                                <td
                                    ...
                                    {{ $data->gunung->nama_gunung }}</td>
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500 text-slate-500">
                                    Rp {{ number_format($data->weekdays_lokal, 0, ',', '.') }}
                                </td>
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500 text-slate-500">
                                    Rp {{ number_format($data->weekend_lokal, 0, ',', '.') }}
                                </td>
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500 text-slate-500">
                                    Rp {{ number_format($data->weekdays_asing, 0, ',', '.') }}
                                </td>
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500 text-slate-500">
                                    Rp {{ number_format($data->weekend_asing, 0, ',', '.') }}
                                </td>
                                <td
                                    class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                    <div class="flex gap-2">
                                        <a href="{{ route('edit-info-tiket', $data->id) }}"
                                        ...
                                        <a href="{{ route('hapus-info-tiket', $data->id) }}"
