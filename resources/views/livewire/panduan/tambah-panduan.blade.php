<div>
    <div class="card">
        <div class="card-body">
            <h6 class="mb-4 text-15 border-b border-slate-200 pb-4 dark:border-navy-500">Buat Panduan Baru</h6>
            ...
            <form wire:submit.prevent="submit" enctype="multipart/form-data">
                <div class="grid grid-cols-1 gap-5 lg:grid-cols-2 xl:grid-cols-12">
                    ...
                    <div class="lg:col-span-2 xl:col-span-12">
                        ...
                        <textarea wire:model="informasi" id="informasi" class="form-input border-slate-200 dark:border-zink-500"
                            placeholder="Informasi panduan" rows="15"></textarea>
                    </div>
                </div><!--end grid-->
                <div class="flex justify-end gap-2 mt-4">
                    <button type="reset" class="btn text-red-500">Reset</button>
                    <button type="submit" class="btn bg-custom-500 text-white">Buat Panduan</button>
                </div>
            </form>
        </div>
    </div>
